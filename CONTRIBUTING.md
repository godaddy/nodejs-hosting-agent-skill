...
to answer questions in [GitHub][issues]. Whether you’re
...
>   ```
> git remote add upstream https://github.com/godaddy/nodejs-hosting-agent-skill.git
> git fetch upstream
...
[issues]: https://github.com/godaddy/nodejs-hosting-agent-skill/issues
